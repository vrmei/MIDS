...
\begin{figure*}[ht!] 
\centerline{\includegraphics[width=1.00\textwidth]{threating module2.png}}
...
\begin{figure}[h]
\centerline{\includegraphics[width=\columnwidth]{frame.png}}
...
\begin{figure*}[!ht]
\centerline{\includegraphics[width=1.00\textwidth]{experiment.png}}
...
To ensure that the performance figures reported in Table~\ref{tab4}
...
Subfigure (d) compares MIDS's performance with that of SOTA models, while Subfigure (e) illustrates MIDS's performance on public datasets. A detailed discussion of these results is provided in Sections~\ref{sec:sota_comp} and \ref{sec:exp_public}.
...
% \begin{figure}[ht] 
% \centering \includegraphics[width=1.00\columnwidth]{f1.png} 
% \caption{Metrics of the MIDS Training Process.} 
% \label{fig:f1}
% \end{figure}

\begin{figure*}[ht] \centering \includegraphics[width=1.00\textwidth]{metrics.png} \caption{Overall model performance and comparisons} \label{fig:f1}
\end{figure*}

% \begin{figure}[ht] \centering \includegraphics[width=1.00\columnwidth]{matrix.png} \caption{Confusion matrix, where Class 0 represents normal data, Class 1 represents ID spoofing attacks, Class 2 represents data spoofing attacks, and Class 3 represents combined spoofing attacks.} 
% \label{fig:matrix}
% \end{figure}

% \begin{figure}[ht] \centering \includegraphics[width=0.9\columnwidth]{graph.jpg} \caption{Class-wise Performance Metrics Visualization: The bar chart illustrates the Precision, Recall, and F1 Score for each class ('Free-attack', 'ID', 'Data', 'Combined').} 
% \label{fig:wise}
% \end{figure}
